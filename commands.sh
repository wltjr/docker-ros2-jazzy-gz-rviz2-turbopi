...
ros2 launch turbopi_ros ign_gazebo.launch.py depth:=True drive:=mecanum lidar:=True world:=playground
...
rm -r build/turbopi_ros/; colcon build --symlink-install --packages-select  turbopi_ros
EOF
